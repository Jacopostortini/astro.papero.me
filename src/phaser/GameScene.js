...
export default class GameScene extends Phaser.Scene {
    ...
    onShipRotated(data){
        ...
        const deltaTheta = ( data[1]-player.ship.rotation>=0 ) ? data[1]-player.ship.rotation>0 : 2*Math.PI - data[1]-player.ship.rotation;
        player.ship.setAngularVelocity( 180 / Math.PI * deltaTheta / deltaTime );
